...
namespace SAFA
{
    ...
    public class d : ContentPage
    {
        ...
        public d(string startpage, String Titles, String BGColor)
        {
            ...
            pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Self-neglect</h3> This covers a wide range of behaviour such as neglecting to care for one's personal hygiene, health or surroundings and includes behaviours such as hoarding. <p> *For more advice on hoarding - contact your local District Borough Council", id = "12", yesbutton = "2", nobutton = "1", yesnext = "17" });

...
namespace SAFA
{
    ...
    public class d : ContentPage
    {
        ...
        public d(string startpage, String Titles, String BGColor)
        {
            ...
            pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Physical Abuse</h3> Includes assault, hitting, slapping, pushing, misusing medication, restraint or inappropriate physical sanctions.", id = "3", yesbutton = "2", nobutton = "1", yesnext = "17", nonext = "6" });
            ...
            pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Sexual abuse</h3> Includes rape, indecent exposure, sexual harassment, inappropriate looking or touching, sexual teasing or innuendo, sexual photography, subjection to pornography or witnessing sexual acts, sexual assault or sexual acts to which the adult has not consented or was pressured into consenting.", id = "5", yesbutton = "2", nobutton = "1", yesnext = "17", nonext = "8" });
            ...
            pages.Add(new Pages { title = "Categories of abuse", description = "<h3 style='color:#953735'>Self-neglect</h3> This covers a wide range of behaviour such as neglecting to care for one's personal hygiene, health or surroundings and includes behaviours such as hoarding. * <br/> For more advice on hoarding - contact your local District Borough Council.", id = "12", yesbutton = "2", nobutton = "1", yesnext = "17" });
            ...
            Label EnterACodeLabel = new Label { Text = "Enter A code ", TextColor = Color.Black };
            Button RevealCodeButton = new Button { Text = "Reveal Code", TextColor = Color.Black };
            ...
            var xx = new ScrollView { Content = x };
           var k = new  StackLayout { Children = { xx, r } };
            Content = k;

        ...
        public Recognising_Abuse()
        {
            ...
            if (Device.OS == TargetPlatform.Windows)
            {
                NavigationPage.SetHasNavigationBar(this, false);
                 s = new Label { HorizontalTextAlignment = Xamarin.Forms.TextAlignment.Center, Text = "Recognising Abuse", TextColor = Color.FromHex("953735"), Font = Font.SystemFontOfSize(24, FontAttributes.Bold) };
                s.HeightRequest = 40;
